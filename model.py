...
from keras.layers import Input, Conv2D, ELU, Flatten, BatchNormalization as BN
...
Class Vaegan():
  def __init__(img_shape=(64, 64, 3), zlen=128):
  ...
  def _build_encoder():
    ...
    mean = Dense(self.zlen, activation="elu")(t)
    logsigma = Dense(self.zlen, activation="elu")(t)
